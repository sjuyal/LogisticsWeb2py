...
def confirm_receive():
    ...
    record['current_pos']=auth.user.place
    record['current_pos_level']=auth.user.levelno
    record['product_status']=3
    
    form = SQLFORM(db.product_info, record,fields=["product_id","product_name","company_name","receiver_name","receiver_email","address","source_place","destination_place","product_status"],submit_button = 'Receive')
